<template>
  <div :class="{ 'cropper-image--circled': circled }" :style="getWrapperStyle">
    <img v-show="isReady" ref="imgElRef" :src="src" :alt="alt" :style="getImageStyle" />
  </div>
</template>
<script lang="ts">
