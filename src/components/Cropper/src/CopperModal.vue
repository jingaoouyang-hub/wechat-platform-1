    ...
    <div class="copperModal">
      <div :class="`copperModal-left`">
        ...
        <div :class="`copperModal-toolbar`">
          ...
          <Space>
            <a-button type="primary" :disabled="!src" @click="handlerToolbar('reset')">
              <template #icon><ReloadOutlined /></template>
            </a-button>
            <a-button type="primary" :disabled="!src" @click="handlerToolbar('rotate', -45)">
              <template #icon><RotateLeftOutlined /></template>
            </a-button>
            <a-button type="primary" :disabled="!src" @click="handlerToolbar('rotate', 45)">
              <template #icon><RotateRightOutlined /></template>
            </a-button>
            <a-button type="primary" :disabled="!src" @click="handlerToolbar('scaleX')">
              <template #icon><SwapOutlined /></template>
            </a-button>
            <a-button type="primary" :disabled="!src" @click="handlerToolbar('scaleY')">
              <template #icon><VerticalAlignMiddleOutlined /></template>
            </a-button>
            <a-button type="primary" :disabled="!src" @click="handlerToolbar('zoom', 0.1)">
      ...
      <div :class="`copperModal-right`">
        <div :class="`copperModal-preview`">
          <img :src="previewSource" v-if="previewSource" />
        </div>
        <template v-if="previewSource">
          <div :class="`copperModal-group`">
